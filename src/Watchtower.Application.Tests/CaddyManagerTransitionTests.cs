...
public sealed class CaddyManagerTransitionTests {
    ...
    // ADR-0022: these fixtures are about what the *Caddy* manager does, and leaning on whichever provider
    ...
    /// <summary>
    /// The default provider is the in-process one (ADR-0022), so enabling the proxy without naming a
