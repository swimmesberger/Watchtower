...
namespace Watchtower.Application.Persistence.Migrations
{
    ...
    [Migration("20260828113059_AddStackGpuMappings")]
    partial class AddStackGpuMappings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Watchtower.Application.Entities.StackDeviceMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_stack_device_mappings");

                    b.HasIndex("StackId", "Service", "HostPath")
                        .IsUnique()
                        .HasDatabaseName("ix_stack_device_mappings_stack_id_service_host_path");

                    b.ToTable("stack_device_mappings", (string)null);
                });
            ...
            modelBuilder.Entity("Watchtower.Application.Entities.StackDeviceMapping", b =>
                {
                    b.HasOne("Watchtower.Application.Entities.Stack", "Stack")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_stack_device_mappings_stacks_stack_id");
